...
const steps = ['Bild hochgeladen', 'Tabelle erkannt', 'Werte zuordnen'];
...
export default function ProcessingScreen() {
  ...
  useEffect(() => {
    ...
    if (job?.status === 'Completed') {
      ...
      router.replace({ pathname: '/capture/photo', params: { ...params, notice: 'Tabelle nicht lesbar — bitte erneut fotografieren' } });
    }
  }, [job, attempts, params]);
  ...
  return (
    <Screen>
      <Text style={[t.font.title, { color: t.color.text }]}>Nährwerte werden extrahiert</Text>
